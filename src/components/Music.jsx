...
import madihaphoto from "../assets/ma__diha.jpeg"
import nethmanemaphoto from "../assets/neth_manema.jpeg";
...
const Music = () => {
  ...
  const featurings = [
    {
      id: 1,
      title: "Featurings Playlist",
      playlistUrl: "https://youtube.com/playlist?list=PLZ1Q5qNS2KWSTIhrpXqNl9FfwMAEPc8HD&si=EWTXY4bJcFiCj-9P",
    },
  ];
  ...
  const productions = [
    {
      id: 1,
      title: "Productions Playlist",
      playlistUrl: "https://youtube.com/playlist?list=PLZ1Q5qNS2KWSgfVjWlGzC5rw4ctvmYgVj&si=K2aedwB80f-LWIve",
    },
  ];
  ...
  <div className="mt-4 flex justify-center sm:hidden w-full">
  <button
    onClick={() => setActiveTab("Productions")}
    className={`w-3/4 max-w-md px-6 py-2 text-lg font-semibold rounded-full ${
    ...
    {["Originals", "Featurings", "Productions"].map((tab) => (
      ...
      >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
          {tracks[activeTab].map(({ id, title, duration, audioUrl, image, playlistUrl }) => (
            <motion.div
              key={id}
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
